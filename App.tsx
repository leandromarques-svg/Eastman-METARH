...
import { LayoutDashboard, FileText, Globe, Lock, Lightbulb, Eye, EyeOff } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 -mt-10 pb-12 relative z-10">
        ...
        <div className="bg-white rounded-xl shadow-lg p-2 mb-8 flex flex-col md:flex-row gap-2 max-w-3xl mx-auto no-print">
          <button 
            ...
            className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-lg transition-all duration-300 font-bold whitespace-nowrap ${
              activeTab === 'overview' 
